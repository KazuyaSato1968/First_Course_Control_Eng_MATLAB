...
%比例要素のゲインと位相の計算
[ gainK phaseK wK ] = bode( sysK, w ); %ゲインと位相を個別に求める
...
semilogx(wK, gainKdB); %片対数グラフでゲイン線図をプロット
...
semilogx(wK, phaseK); %片対数グラフで位相線図をプロット
xlim([10^(-3),10^3]) %横軸（角周波数）の範囲の指定
ylim([-90 0]) %縦軸の範囲の指定
...
subplot(2,1,2) %複数の図を並べるためのコマンド．2行1列の2行目という意味
semilogx(w1, phase1); %片対数グラフで位相線図をプロット
xlim([10^(-3),10^3]) %横軸（角周波数）の範囲の指定
ylim([-90 0]) %縦軸の範囲の指定
yticks([-90 -45 0]) %縦軸の目盛りの値の設定
grid; %罫線を表示
...
subplot(2,1,2) %複数の図を並べるためのコマンド．2行1列の2行目という意味
semilogx(w2, phase2); %片対数グラフで位相線図をプロット
xlim([10^(-3),10^3]) %横軸（角周波数）の範囲の指定
ylim([-90 0]) %縦軸の範囲の指定
yticks([-90 -45 0]) %縦軸の目盛りの値の設定
grid; %罫線を表示
...
subplot(2,1,2) %複数の図を並べるためのコマンド．2行1列の2行目という意味
semilogx(w3, phase3); %片対数グラフで位相線図をプロット
xlim([10^(-3),10^3]) %横軸（角周波数）の範囲の指定
ylim([-90 0]) %縦軸の範囲の指定
yticks([-90 -45 0]) %縦軸の目盛りの値の設定
grid; %罫線を表示
...
figure(5) %図のウィンドウを開く
subplot(2,1,1) %複数の図を並べるためのコマンド．2行1列の1行目という意味
semilogx(w3, gainKdB + gain1dB + gain2dB + gain3dB); %片対数グラフでゲイン線図をプロット
xlim([10^(-3),10^3]) %横軸（角周波数）の範囲の指定
ylim([-40 40]) %縦軸の範囲の指定
grid; %罫線を表示
xlabel('Frequency (rad/s)'); %横軸のラベル表示
...
subplot(2,1,2) %複数の図を並べるためのコマンド．2行1列の2行目という意味
semilogx(w3, phaseK + phase1 + phase2 + phase3); %片対数グラフで位相線図をプロット
xlim([10^(-3),10^3]) %横軸（角周波数）の範囲の指定
ylim([-90 0]) %縦軸の範囲の指定
yticks([-90 -45 0]) %縦軸の目盛りの値の設定
grid; %罫線を表示
